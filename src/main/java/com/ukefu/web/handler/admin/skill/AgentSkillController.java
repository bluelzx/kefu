package com.ukefu.web.handler.admin.skill;
...
import com.ukefu.service.repository.SkillRepository;
...
public class AgentSkillController extends Handler{
    ...
    public ModelAndView save(HttpServletRequest request ,@Valid Skill skill) {
    	Skill tempSkill = skillRepository.findByName(skill.getName()) ;
    ...
    public ModelAndView edit(ModelMap map , @Valid String id) {
    	...
    	view.addObject("skillData", skillRepository.findById(id)) ;
        return view;
    }
    ...
    public ModelAndView update(HttpServletRequest request ,@Valid Skill skill) {
    	Skill tempSkill = skillRepository.findById(skill.getId()) ;
